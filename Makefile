...
PATCHLEVEL = 4
SUBLEVEL = 113
EXTRAVERSION = -Minori-UNRELEASED
...
KERNELFLAGS	= -munaligned-access -fforce-addr -fsingle-precision-constant -mcpu=cortex-a15 -mtune=cortex-a7 -marm -mfpu=neon-vfpv4 -fgcse-las
...
KBUILD_CFLAGS   := -Wall -DNDEBUG -Wundef -Wstrict-prototypes -Wno-trigraphs \
		   ...
		   -mcpu=cortex-a15 -mtune=cortex-a7 -mfpu=neon-vfpv4 -marm \
