...
CROSS_COMPILE_HYPER="$HOME/arm-linux-androideabi-4.9/bin"
...
export ARCH=arm
export CROSS_COMPILE=$CROSS_COMPILE_HYPER/arm-linux-androideabi-
make ARCH=arm yume_flamingo_defconfig
make ARCH=arm CROSS_COMPILE=$CROSS_COMPILE_HYPER/arm-linux-androideabi- -j$(nproc --all) -> minori.log
cd $kernel_source
